...
Cette pratique est qualifiée de politique de "double licence". Elle permet d'autoriser l'innovation et la création de valeur par le plus grand nombre tout en conservant aux administrations leur clientèle classique moins disposée à partager les données qu'elles "mixent" avec celles des administrations, préservant ainsi la sensation de garder un avantage concurentiel.
